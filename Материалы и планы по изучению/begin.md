Абсолютно нормально! Это отличный ход — вернуться к **базовому, но практическому уровню**, чтобы не просто читать термины вроде *Spark*, *pipeline*, *DAG*, а реально понимать, что за этим стоит.
